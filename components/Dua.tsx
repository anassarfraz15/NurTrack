...
const Dua: React.FC<DuaProps> = ({ onOpenDrawer }) => {
  ...
  return (
    <div className="flex flex-col h-full animate-in fade-in duration-500 relative">
      {/* Header Section */}
      <header className="sticky top-0 z-30 flex-shrink-0 mb-4 flex flex-col items-center relative -mx-4 px-4 pt-4 pb-2 bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-xl lg:static lg:bg-transparent lg:backdrop-blur-none lg:mx-0 lg:px-0 lg:pt-0">
        <button 
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar relative">
              ...
              {selectedStep.id > 1 && (
                  <div className="flex flex-col items-center justify-center h-48 text-center text-slate-400">
                      <p>Details for step {selectedStep.id} coming soon.</p>
                  </div>
              )}
            </div>
          </div>
