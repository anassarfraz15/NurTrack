...
const AchievementPopup: React.FC<AchievementPopupProps> = ({ onClose, title, message, userName }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm animate-overlay overflow-hidden">
      
      {/* Main Popup Content - Lower Z-Index (z-10) */}
      <div className="bg-white dark:bg-slate-900 w-full max-w-sm rounded-[3rem] overflow-hidden shadow-2xl shadow-emerald-500/30 border border-emerald-100 dark:border-emerald-900/50 animate-popup relative z-10">
